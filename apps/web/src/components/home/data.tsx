...
export const navItems: NavItem[] = [
  ...
  { label: 'Bookings', icon: CalendarDays, href: '/bookings', slug: 'bookings' },
...
export const seasonalDeals = [
  ...
  },
  {
    ...
    href: '#offers',
    image: 'https://images.unsplash.com/photo-1599256872237-5dcc0fbe9668?auto=format&fit=crop&w=400&q=80',
  },
  {
  ...
  },
  {
    ...
    strikePrice: '\u20B92,600',
    discount: '31% OFF',
    imageTone: 'from-[#1c1031] via-[#6146a3] to-[#d9c8ff]',
    href: '#offers',
  ...
  },
  {
    ...
    strikePrice: '\u20B92,200',
    discount: '32% OFF',
    imageTone: 'from-[#0f2a2b] via-[#2f7876] to-[#d6fff8]',
    href: '#offers',
...
export const emergencyItems = [
  { title: 'Roadside Assistance', icon: Siren, href: 'tel:+919999999999' },
  { title: 'Tow Truck', icon: Truck, href: 'tel:+919999999999' },
  { title: 'Battery Jump Start', icon: BatteryCharging, href: 'tel:+919999999999' },
  { title: 'Call Support', icon: Phone, href: 'tel:+919999999999' },
];
